...
public class Utiles
{
    ...
    public static void hacerCabecera(String frase, String decorador,  int espaciadoX,int distanciaX)
    {
        int largo = 1 + espaciadoX + frase.length() +  espaciadoX + 1;
        String nuevaLinea="";
        //Primera linea
        ...
        for (int i = 1 ; i<=largo; i++)
        {
            ...
            System.out.print(decorador.toString());
            
        }
        
        System.out.println("");//puede haber problema aca
        
        nuevaLinea = decorador.toString();
        
        for (int i = 1 ; i<=espaciadoX; i++)
        {
        ...
        nuevaLinea = nuevaLinea + frase.toString(); 
        ...
        nuevaLinea = nuevaLinea + decorador.toString();
        
        System.out.print(nuevaLinea.toString());
